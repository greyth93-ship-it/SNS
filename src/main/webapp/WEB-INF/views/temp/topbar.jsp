...
<nav
	...
	<ul class="navbar-nav ml-auto">
		<sec:authorize access="isAuthenticated()">
			...
			<li class="nav-item dropdown no-arrow mx-1"><a
				...
				aria-expanded="false"> <i class="fas fa-bell fa-fw"></i> <span
					class="badge badge-danger badge-counter" id="alarm-count"
				...
				<div
					...
					<div id="alarm-items-container"></div>

					<a class="dropdown-item text-center small text-gray-500"
						href="/push/allList">모든 알림 보기</a>
				</div></li>
			...
			<li class="nav-item dropdown no-arrow"><a
				...
				aria-expanded="false"> <span
					class="mr-2 d-none d-lg-inline text-gray-600 small">
						${member.userNickname}</span> <img class="img-profile rounded-circle"
					src="/files/member/${member.profileDTO.fileName}">
		...
		<sec:authorize access="!isAuthenticated()">
			<li class="nav-item mx-3"><a href="/member/join"><i
					class="fas fa-user-plus"></i></a></li>
			<li class="nav-item mx-3"><a href="/member/login"><i
