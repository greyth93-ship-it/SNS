					...
					<div class="row justify-content-center">
						<div class="col-lg-10">
							<div class="search-hero">
								...
								<form method="get" action="/follow/follower" class="mt-3">
											...
											<div class="user-card">
												<c:choose>
													<c:when test="${u.mutual}">
														<a href="/chat/create?targetUserNo=${u.memberDTO.userNo}"
						...
						<nav aria-label="Page navigation example">
							<ul class="pagination">
								<li class="page-item ${pager.pre ? '' : 'disabled'}"><a
									class="page-link"
									href="/follow/follower?page=${pager.pre ? pager.start-1 : pager.start}&search=${pager.search}&kind=${pager.kind}&userNo=${currentUserNo}"
								...
								<c:forEach begin="${pager.start}" end="${pager.end}" var="i">
                                        <li class="page-item ${pager.page == i ? 'active' : ''}">
                                        	<a class="page-link"
                                        	href="/follow/follower?page=${i}&search=${pager.search}&kind=${pager.kind}&userNo=${currentUserNo}">${i}</a>
                                        </li>
								</c:forEach>

								<li class="page-item ${pager.next ? '' : 'disabled'}"><a
									class="page-link"
									href="/follow/follower?page=${pager.next ? pager.end+1 : pager.end}&search=${pager.search}&kind=${pager.kind}&userNo=${currentUserNo}"
